...
const NewStory = () => {
  ...
  const mint = async (account, uri) => {
    let options = {
      contractAddress: "0x2a4b75bC3b1C09ACB5eD0A5b8FF4Bffc2C469367",
      ...
      <div>
        <form onSubmit={uploadFile} className="writeForm">
          <div className="writeFormGroup">
            <input className="writeInput" placeholder="Title" type="text" autoFocus={true} value={tittle} onChange={(e) => setTittle(e.target.value)} />
          </div>
          <div className="writeFormGroup">
